...
class BottomProjectConfirm extends StatelessWidget {
  ...
  BottomProjectConfirm({this.isMultiple = '0'});
        ...
        if (selectedIdx == -1) {
          ...
          if (isMultiple == '1') {
            Global.formRecord['receive_ids'] =
                listData.where((item) => item.isCheck);
          } else {
            Global.formRecord['receive_id'] = listData[selectedIdx].id;
            Global.formRecord['receive_name'] = listData[selectedIdx].name;
          }
