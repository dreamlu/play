...
class QuestionViewPage extends StatefulWidget {
  ...
  QuestionViewPage(this.params);
  @override
  _QuestionViewPageState createState() => _QuestionViewPageState();
}
...
class _QuestionViewPageState extends State<QuestionViewPage> {
  ...
  Widget _formList(
    ...
    return Container(
      ...
      child: Wrap(
        children: [
          QuestionFormItem('name', "问题内容", "暂未填写", minLines: 5, enabled: false),
          QuestionFormItem(
            'name',
            "问题图片",
            "未上传图片",
          ...
          widget.params["tabIdx"] == '1'
              ? QuestionFormItem('name', "回执内容", "负责人暂未回执",
