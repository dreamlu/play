  ...
  Widget build(BuildContext context) {
    ...
    void handleSign() async {
      ...
      if (await context.read<PdfProvider>().handleSign()) {
        ...
        await context.read<ApproveProvider>().handleStatus();
    ...
    void handleReject() async {
      ...
      if (isConfirm) {
        ...
        context.read<ApproveProvider>().handleStatus();
      }
    }
      ...
      child: Positioned(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: isCert
                  ? [
                      BottomBtn('取消审批', Color(0xFF999999), onTap: () {
                        context.read<PdfProvider>().handleisCert(false);
                      }),
                      BottomBtn('确认提交', Color(0xFF009CFF), onTap: handleSign),
                    ]
                  : [
                      BottomBtn('拒绝审批', Color(0xFFFF6565), onTap: handleReject),
                      BottomBtn('同意审批', Color(0xFF00C86C),
